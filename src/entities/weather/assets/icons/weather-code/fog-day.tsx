export const FogDayIcon = ({ className = '' }: { className?: string }) => (
  <svg
    className={className}
  ...
  >
    ...
    <g fill='none'>
      ...
      <path
        fill='url(#b)'
        d='M2 19.001v-.001c.552 0 1-.448 1-1s-.448-1-1-1-1-.448-1-1 .448-1 1-1 1-.448 1-1-.448-1-1-1-1-.448-1-1 .448-1 1-1h8c.552 0 1 .448 1 1s-.448 1-1 1-1 .448-1 1 .448 1 1 1h6c.552 0 1 .448 1 1s-.448 1-1 1-1 .448-1 1 .448 1 1 1h4.045c.552 0 1 .448 1 1s-.448 1-1 1h-18c-.552 0-1-.448-1-1 0-.537.424-.976.955-.999z'
        opacity='.75'
      />
    </g>
  </svg>
