...
export interface WeatherHourly {
  time: Date[]
  temperature2m: Float32Array | number[] // Принимаем оба варианта
...
export const isWeatherCode = (code: number | undefined): code is WeatherCode => {
  if (code === undefined) return false
  return Object.keys(WEATHER_CODE_DESCRIPTIONS).map(Number).includes(code)
}
